<x-default-layout title="Gestion des matières">
    <div class="flex">
            ...
            <div class="px-4 sm:px-6 lg:px-8 mt-5">
                <div class="flex flex-col">
                    <div class="sm:flex-auto">
                        <h1 class="text-2xl font-bold mt-4">Matières</h1>
                    ...
                    <div class="mt-4 sm:mt-0 sm:flex-none">
                        <a href="{{ route('admin.matieres.create') }}">
                            <button type="submit" class="mt-8 w-60 h-12 px-2 bg-black text-white">CREER UNE MATIERE</button>
                        </a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-2 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            <div class="flex justify-start space-x-1">
                                                <a href="{{ route('admin.matieres.edit', ['matiere' => $matiere]) }}" class="p-1 border-2 border-indigo-500 rounded-md">
